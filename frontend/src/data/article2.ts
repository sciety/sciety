...
const article: ReviewedArticle = {
  ...
  reviews: [
    {
      author: 'EMBOpress',
      url: 'https://hypothes.is/a/JFxMDnpkEeqyx09LkDotfQ',
      publicationDate: new Date('2020-04-09'),
      summary: `We thank all the Reviewers for taking the time to evaluate our manuscript and providing us with
...
PALB2 in DNA repair’.`,
    ...
    {
      author: 'EMBOpress',
      url: 'https://hypothes.is/a/I-FC6HpkEeqdRav-80EtSA',
      publicationDate: new Date('2020-04-09'),
      summary: `<p>
...
<p>
  ...
  behaviour and response to DNA damage.
    ...
    {
      author: 'EMBOpress',
      url: 'https://hypothes.is/a/I36NiHpkEeqdZutVpxr6uQ',
      publicationDate: new Date('2020-04-09'),
      summary: `<p>
  ...
  findings in the context of DNA replication and DNA repair.
    ...
    {
      author: 'EMBOpress',
      url: 'https://hypothes.is/a/I0iGrHpkEeqtkxu-1NyIbQ',
      publicationDate: new Date('2020-04-09'),
      summary: `<p>
