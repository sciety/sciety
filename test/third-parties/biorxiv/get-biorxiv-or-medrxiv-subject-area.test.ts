...
import { constructGetBiorxivOrMedrxivSubjectArea } from '../../../src/third-parties/biorxiv/get-biorxiv-or-medrxiv-subject-area';
...
describe('get-biorxiv-or-medrxiv-subject-area', () => {
  describe('when the subject area is available on biorxiv', () => {
    ...
    beforeEach(async () => {
      result = await constructGetBiorxivOrMedrxivSubjectArea(ports)(arbitraryDoi())();
    });
