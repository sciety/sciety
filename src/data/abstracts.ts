export default {
  '10.1101/642017': `Innate lymphoid cells (ILCs) were originally classified based on their cytokine profiles, placing
   ...
   ILC1s were Eomes-dependent, indicating that NK cells can give rise to Eomes<sup>−</sup> Tbet-dependent ILC1-like
