...
export const bootstrapGroups: RNEA.ReadonlyNonEmptyArray<DomainEvent.GroupJoinedEvent> = [
  DomainEvent.groupJoined({
    ...
    descriptionPath: descriptionPathFromValidatedString('biophysics-colab--4bbf0c12-629b-4bb8-91d6-974f4df8efb2.md'),
  ...
  DomainEvent.groupJoined({
    ...
    descriptionPath: descriptionPathFromValidatedString('asapbio-crowd-review--50401e46-b764-47b7-8557-6bb35444b7c8.md'),
  ...
  DomainEvent.groupJoined({
    ...
    descriptionPath: descriptionPathFromValidatedString('ncrc--62f9b0d0-8d43-4766-a52a-ce02af61bc6a.md'),
  ...
  DomainEvent.groupJoined({
    ...
    descriptionPath: descriptionPathFromValidatedString('rapid-reviews-covid-19--5142a5bc-6b18-42b1-9a8d-7342d7d17e94.md'),
  ...
  DomainEvent.groupJoined({
    ...
    descriptionPath: descriptionPathFromValidatedString('elife--b560187e-f2fb-4ff9-a861-a204f3fc0fb0.md'),
  ...
  DomainEvent.groupJoined({
    ...
    descriptionPath: descriptionPathFromValidatedString('screenit--8ccea9c2-e6c8-4dd7-bf1d-37c3fa86ff65.md'),
  ...
  DomainEvent.groupJoined({
    ...
    descriptionPath: descriptionPathFromValidatedString('prelights--f97bd177-5cb6-4296-8573-078318755bf2.md'),
  ...
  DomainEvent.groupJoined({
    ...
    descriptionPath: descriptionPathFromValidatedString('prereview-community--10360d97-bf52-4aef-b2fa-2f60d319edd7.md'),
  ...
  DomainEvent.groupJoined({
    ...
    descriptionPath: descriptionPathFromValidatedString('peerj--53ed5364-a016-11ea-bb37-0242ac130002.md'),
  ...
  DomainEvent.groupJoined({
    ...
    descriptionPath: descriptionPathFromValidatedString('review-commons--316db7d9-88cc-4c26-b386-f067e0f56334.md'),
  ...
  DomainEvent.groupJoined({
    ...
    descriptionPath: descriptionPathFromValidatedString('pci-zoology--74fd66e9-3b90-4b5a-a4ab-5be83db4c5de.md'),
  ...
  DomainEvent.groupJoined({
    ...
    descriptionPath: descriptionPathFromValidatedString('pci-evolutionary-biology--19b7464a-edbe-42e8-b7cc-04d1eb1f7332.md'),
  ...
  DomainEvent.groupJoined({
    ...
    descriptionPath: descriptionPathFromValidatedString('pci-ecology--32025f28-0506-480e-84a0-b47ef1e92ec5.md'),
  ...
  DomainEvent.groupJoined({
    ...
    descriptionPath: descriptionPathFromValidatedString('pci-animal-science--4eebcec9-a4bb-44e1-bde3-2ae11e65daaa.md'),
  ...
  DomainEvent.groupJoined({
    ...
    descriptionPath: descriptionPathFromValidatedString('pci-archaeology--b90854bf-795c-42ba-8664-8257b9c68b0c.md'),
  ...
  DomainEvent.groupJoined({
    ...
    descriptionPath: descriptionPathFromValidatedString('pci-paleontology--7a9e97d1-c1fe-4ac2-9572-4ecfe28f9f84.md'),
  ...
  DomainEvent.groupJoined({
    ...
    descriptionPath: descriptionPathFromValidatedString('pci-neuroscience--af792cd3-1600-465c-89e5-250c48f793aa.md'),
  ...
  DomainEvent.groupJoined({
    ...
    descriptionPath: descriptionPathFromValidatedString('gigascience--d6e1a913-76f8-40dc-9074-8eac033e1bc8.md'),
  ...
  DomainEvent.groupJoined({
    ...
    descriptionPath: descriptionPathFromValidatedString('gigabyte--f7a7aec3-8b1c-4b81-b098-f3f2e4eefe58.md'),
  ...
  DomainEvent.groupJoined({
    ...
    descriptionPath: descriptionPathFromValidatedString('arcadia-science--bc1f956b-12e8-4f5c-aadc-70f91347bd18.md'),
