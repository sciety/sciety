          ...
          <ol role="list"> 
            <li>  
              <article>          
                ...
                <div><time datetime="2020-09-15">Sep 15, 2020</time></div>
                <p>
...
<p>1) Overall, the authors have employed very good QC parameters to filter superior quality cells. However, they detected batch effects in data (patient-specific clustering) and therefore employed batch correction methods. Unfortunately, after batch correction, they fail to detect tumor-specific macrophage populations in prostate cancer. The authors' reason that this could be due to the broader effect of 'tumor' on the adjacent normal ecosystem. However, in the absence of a comparison between macrophages from normal prostate and prostate tumor, it's difficult …</div>
        ...
        <div>
          <a href="https://hyp.is/MGYjtPdTEeqFAGMfJZKfBQ/www.biorxiv.org/content/10.1101/2020.06.19.160770v1">
...
<p>1) The patient numbers analysed are very small. There are only four clinical …</div>
        ...
        <div>
          <a href="https://hyp.is/Sxjt1vdTEeqrk589L9I9zg/www.biorxiv.org/content/10.1101/2020.06.19.160770v1">
            Read the full review
          </a>
        </div>
...
<p>1) The authors state that they identified three distinct populations of tissue resident macrophages in prostate tissue, independent of the localisation. This finding is surprising, since an accumulation of monocyte-derived tumor(-associated) macrophages can be observed in almost all tumors. According to the material and methods section, the authors did not digest their tissue. What is the impact of digestion vs. non-digestion on macrophage recovery from human prostate tissue? Is it possible that especially tissue-resident macrophage subsets embedded in the parenchyma were missed? A detailed flow cytometry experiment needs to be performed in order to identify …</div>
        ...
        <div>
          <a href="https://hyp.is/e23E8vdTEeqrE0uwZQ5ZmQ/www.biorxiv.org/content/10.1101/2020.06.19.160770v1">
            Read the full review
          </a>
        </div>
