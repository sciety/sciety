...
<li class="item">Andries M Bergman</li>
      ...
      <section role="doc-abstract">
        <h2>
          ...
          <a href="https://doi.org/10.1101/2020.06.19.160770" class="ui basic secondary button">
...
<li class="item">
      <article class="content">
        ...
        <div class="description" data-test-id="reviewSummary"><p>###Reviewer #1:</p>
...
<p>1) Overall, the authors have employed very good QC parameters to filter superior quality cells. However, they detected batch effects in data (patient-specific clustering) and therefore employed batch correction methods. Unfortunately, after batch correction, they fail to detect tumor-specific macrophage populations in prostate cancer. The authors' reason that this could be due to the broader effect of 'tumor' on the adjacent normal ecosystem. However, in the absence of a comparison between macrophages from normal prostate and prostate tumor, it's difficult …</div>

        <div class="extra">
          <a href="https://hyp.is/MGYjtPdTEeqFAGMfJZKfBQ/www.biorxiv.org/content/10.1101/2020.06.19.160770v1" class="ui basic secondary button" id="review-1-read-more"
...
<li class="item">
      <article class="content">
        ...
        <div class="description" data-test-id="reviewSummary"><p>###Reviewer #2:</p>
...
<p>1) The patient numbers analysed are very small. There are only four clinical …</div>

        <div class="extra">
          <a href="https://hyp.is/Sxjt1vdTEeqrk589L9I9zg/www.biorxiv.org/content/10.1101/2020.06.19.160770v1" class="ui basic secondary button" id="review-2-read-more"
...
<li class="item">
      <article class="content">
        ...
        <div class="description" data-test-id="reviewSummary"><p>###Reviewer #3:</p>
