              ...
              <ol role="list">
                <li>
                  <article>
                    ...
                    <p>1) Overall, the authors have employed very good QC parameters to filter superior quality cells. However, they detected batch effects in data (patient-specific clustering) and therefore employed batch correction methods. Unfortunately, after batch correction, they fail to detect tumor-specific macrophage populations in prostate cancer. The authors' reason that this could be due to the broader effect of 'tumor' on the adjacent normal ecosystem. However, in the absence of a comparison between macrophages from normal prostate and prostate tumor, it's difficult …
                    </div>
                ...
                <li>
                  <article>
                    ...
                    <p>1) The patient numbers analysed are very small. There are only four clinical …
                    </div>
