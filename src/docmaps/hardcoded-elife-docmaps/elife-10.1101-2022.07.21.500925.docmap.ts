      ...
      actions: [
        ...
        },
        {
          participants: [
            {
              actor: {
                name: 'Richard W Aldrich',
                type: 'person',
                _relatesToOrganization: 'The University of Texas at Austin, United States',
              },
              role: 'senior-editor',
            },
            {
              actor: {
                name: 'Leon D Islas',
                type: 'person',
                _relatesToOrganization: 'Universidad Nacional Autónoma de México, Mexico',
              },
              role: 'editor',
            },
          ],
