...
export const renderPage = (viewModel: ViewModel): HtmlFragment => toHtmlFragment(`
    ...
    <p>Create an annotation for <a href="/articles/${viewModel.articleId}" class="annotation-form-article-title">${viewModel.articleTitle}</a> on <a href="/lists/${viewModel.listId}" class="annotation-form-list-name">${viewModel.listName}</a></p>
