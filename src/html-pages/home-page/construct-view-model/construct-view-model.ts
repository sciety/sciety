...
const curationTeaser1: ViewModel['curationTeasers'][number] = {
...
const curationTeaser2: ViewModel['curationTeasers'][number] = {
...
const curationTeaser3: ViewModel['curationTeasers'][number] = {
