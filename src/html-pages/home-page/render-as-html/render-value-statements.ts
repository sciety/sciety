    ...
    <section class="home-page-value-statements-wrapper">
      <div class="home-page-value-statements">
        ...
        <article class="home-page-value-statement">
            ...
            <img src="/static/images/home-page/first-value-placeholder.svg" alt="placeholder image" class="home-page-value-statement__image">
        </article>
        <article class="home-page-value-statement">
            <div class="home-page-value-statement__copy">
            ...
            <img src="/static/images/home-page/second-value-placeholder.svg" alt="placeholder image" class="home-page-value-statement__image">
        </article>
        <article class="home-page-value-statement">
            <div class="home-page-value-statement__copy">
            ...
            <img src="/static/images/home-page/third-value-placeholder.svg" alt="placeholder image" class="home-page-value-statement__image">
        </article>
        </div>
    </section>
  `);
