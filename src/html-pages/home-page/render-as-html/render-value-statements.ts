    ...
    <section class="home-page-value-statements-wrapper">
      <div class="home-page-value-statements">
        ...
        <article class="home-page-value-statement home-page-value-statement--reverse-order">
            ...
            <img src="/static/images/home-page/value-statements/illustration-2.svg" alt="placeholder image" class="home-page-value-statement__image">
        </article>
        <article class="home-page-value-statement">
            <div class="home-page-value-statement__copy">
            ...
            <img src="/static/images/home-page/value-statements/illustration-3.svg" alt="placeholder image" class="home-page-value-statement__image">
        </article>
        </div>
    </section>
  `);
