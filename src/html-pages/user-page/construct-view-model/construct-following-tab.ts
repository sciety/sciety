...
import { populateGroupViewModel, Ports } from '../../../shared-components/group-card/populate-group-view-model';
import { GroupId } from '../../../types/group-id';

export { Ports } from '../../../shared-components/group-card/populate-group-view-model';
