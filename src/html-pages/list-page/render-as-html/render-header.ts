...
export const renderHeader = (viewModel: ViewModel): HtmlFragment => pipe(
  `<header class="page-header page-header--list">
    ...
    <br><a class="page-header__related_articles"href="https://labs.sciety.org/lists/by-id/${viewModel.listId}/article-recommendations">See articles related to this list on Sciety Labs</a>
  </header>`,
  toHtmlFragment,
);
