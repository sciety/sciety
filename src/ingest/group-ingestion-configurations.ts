...
export const groupIngestionConfigurations: Array<GroupIngestionConfiguration> = [
  {
    ...
    discoverPublishedEvaluations: fetchReviewsFromHypothesisGroup('ApM1XL6A'),
  },
  {
    id: 'b560187e-f2fb-4ff9-a861-a204f3fc0fb0',
    name: 'eLife',
    discoverPublishedEvaluations: fetchReviewsFromHypothesisGroup('q5X6RWJ6'),
  },
  {
    id: '74fd66e9-3b90-4b5a-a4ab-5be83db4c5de',
    name: 'PCI Zoology',
    discoverPublishedEvaluations: fetchPciEvaluations('https://zool.peercommunityin.org/rss/rss4elife'),
  },
  {
    id: '19b7464a-edbe-42e8-b7cc-04d1eb1f7332',
    name: 'PCI Evolutionary Biology',
    discoverPublishedEvaluations: fetchPciEvaluations('https://evolbiol.peercommunityin.org/rss/rss4elife'),
  },
  {
    id: '32025f28-0506-480e-84a0-b47ef1e92ec5',
    name: 'PCI Ecology',
    discoverPublishedEvaluations: fetchPciEvaluations('https://ecology.peercommunityin.org/rss/rss4elife'),
  },
  {
    id: '4eebcec9-a4bb-44e1-bde3-2ae11e65daaa',
    name: 'PCI Animal Science',
    discoverPublishedEvaluations: fetchPciEvaluations('https://animsci.peercommunityin.org/rss/rss4elife'),
  },
  {
    id: 'b90854bf-795c-42ba-8664-8257b9c68b0c',
    name: 'PCI Archaeology',
    discoverPublishedEvaluations: fetchPciEvaluations('https://archaeo.peercommunityin.org/rss/rss4elife'),
  },
  {
    id: '7a9e97d1-c1fe-4ac2-9572-4ecfe28f9f84',
    name: 'PCI Paleontology',
    discoverPublishedEvaluations: fetchPciEvaluations('https://paleo.peercommunityin.org/rss/rss4elife'),
  },
  {
    id: 'af792cd3-1600-465c-89e5-250c48f793aa',
    name: 'PCI Neuroscience',
    discoverPublishedEvaluations: fetchPciEvaluations('https://neuro.peercommunityin.org/rss/rss4elife'),
  },
  {
  ...
  },
  {
    ...
    name: 'Review Commons',
    discoverPublishedEvaluations: fetchReviewsFromHypothesisGroup('NEGQVabn'),
  },
  {
    id: 'f2c9eafa-6e24-4549-819c-09179e642b08',
    name: 'Life Science Editors Foundation',
    discoverPublishedEvaluations: fetchReviewsFromHypothesisUser('lifescienceeditorsfoundation'),
  },
  {
    id: '1480d2dd-463f-4834-8e81-d89c8ae2b86f',
    name: 'Life Science Editors',
    discoverPublishedEvaluations: fetchReviewsFromHypothesisUser('lifescienceeditors'),
  },
  {
    id: '8ccea9c2-e6c8-4dd7-bf1d-37c3fa86ff65',
    name: 'ScreenIT',
    discoverPublishedEvaluations: fetchReviewsFromHypothesisUser('sciscore'),
  },
  {
    id: '4bbf0c12-629b-4bb8-91d6-974f4df8efb2',
    name: 'Biophysics Colab',
    discoverPublishedEvaluations: fetchReviewsFromHypothesisUser('biophysics_sciencecolab'),
  },
  {
    id: '50401e46-b764-47b7-8557-6bb35444b7c8',
    name: 'ASAPbio crowd review',
    discoverPublishedEvaluations: fetchReviewsFromHypothesisUser('ASAPbio_crowd_preprint_review'),
  },
  {
    id: 'b5f31635-d32b-4df9-92a5-0325a1524343',
    name: 'PeerRef',
    discoverPublishedEvaluations: fetchReviewsFromHypothesisGroup('LN28Q33j'),
  },
  {
    id: 'd6e1a913-76f8-40dc-9074-8eac033e1bc8',
    name: 'GigaScience',
    discoverPublishedEvaluations: fetchReviewsFromHypothesisGroup('x6WjqQay'),
  },
  {
    id: 'f7a7aec3-8b1c-4b81-b098-f3f2e4eefe58',
    name: 'GigaByte',
    discoverPublishedEvaluations: fetchReviewsFromHypothesisGroup('z4oRbDWY'),
  },
  {
    id: '36fbf532-ed07-4573-87fd-b0e22ee49827',
    name: 'ASAPbio-SciELO Preprint crowd review',
    discoverPublishedEvaluations: fetchReviewsFromHypothesisUser('ASAPbio_SciELO_preprint_review'),
  },
  {
    id: '1e6f6b49-2a9b-417e-831b-8cee5af033bd',
    name: 'The Unjournal',
    discoverPublishedEvaluations: fetchReviewsFromHypothesisUser('theunjournal', 60),
  },
  {
    id: '4d6a8908-22a9-45c8-bd56-3c7140647709',
    name: 'Access Microbiology',
    discoverPublishedEvaluations: fetchEvaluationsForAccessMicrobiologyViaCrossref,
  },
];
