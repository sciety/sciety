...
const yourFeedMenuItem = () => toHtmlFragment(`
  <li><a href="/" class="site-menu__link site-menu__link--feed"><span class="site-menu__link_text">My feed</span></a></li>
`);
...
export const siteMenuItems = (user: O.Option<User>): HtmlFragment => toHtmlFragment(`
  <ul role="list" class="site-menu__links">
    ...
    ${O.fold(constant(''), yourFeedMenuItem)(user)}
