...
export { Ports as ConstructArticleCardViewModelPorts, constructArticleCardViewModel } from './construct-article-card-view-model';
...
export { Ports } from './get-latest-article-version-date';
